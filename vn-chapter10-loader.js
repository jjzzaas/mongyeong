const entryUrl = new URL('./vn-3.2.js?v=vn-3.2-chapter14-source', window.location.href);
...
source = source.replace(
  ...
  "import { chapter011 } from '" + baseUrl + "src/chapters/011-020/chapter-011.js';\n" +
  "import { chapter012 } from '" + baseUrl + "src/chapters/011-020/chapter-012.js';\n" +
  "import { chapter013 } from '" + baseUrl + "src/chapters/011-020/chapter-013.js';\n" +
  "import { chapter014 } from '" + baseUrl + "src/chapters/011-020/chapter-014.js';",
);
source = source.replace(
